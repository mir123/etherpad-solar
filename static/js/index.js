exports.aceSetAuthorStyle = function (hook_name, args, cb) {
  ...
  // }
    ...
    var elevation = solarElevation(latitude, longitude);
  
    console.log(elevation);

    var luz = elevation > dayElevation ? 'day' : 'night';
  ...
  function solarElevation(latitude, longitude, date) {
